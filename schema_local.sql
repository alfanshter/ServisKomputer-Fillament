...
CREATE TABLE `sparepart_purchases` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `sparepart_id` bigint unsigned NOT NULL,
  `quantity` int NOT NULL COMMENT 'Jumlah dibeli',
  `cost_price` decimal(12,2) NOT NULL COMMENT 'Harga modal per unit saat beli',
  `margin_persen` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT 'Margin keuntungan dalam persen',
  `harga_jual` decimal(12,2) DEFAULT NULL COMMENT 'Harga jual per unit',
  `total_cost` decimal(12,2) NOT NULL COMMENT 'Total biaya pembelian',
  `purchase_date` date NOT NULL COMMENT 'Tanggal pembelian',
  `supplier` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Nama supplier',
  `notes` text COLLATE utf8mb4_unicode_ci COMMENT 'Catatan pembelian',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sparepart_purchases_sparepart_id_foreign` (`sparepart_id`),
  CONSTRAINT `sparepart_purchases_sparepart_id_foreign` FOREIGN KEY (`sparepart_id`) REFERENCES `spareparts` (`id`) ON DELETE CASCADE
...
CREATE TABLE `spareparts` (
  ...
  `cost_price` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT 'Harga modal/beli',
  `margin_percent` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT 'Margin keuntungan dalam persen',
  `average_cost` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT 'Rata-rata harga modal dari semua pembelian',
...
-- Dump completed on 2025-11-20 14:17:32
