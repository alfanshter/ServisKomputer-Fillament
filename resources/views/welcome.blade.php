                ...
                <div class="hero-content fade-in-up">
                    ...
                    <div class="hero-image">
                        <svg viewBox="0 0 500 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="50" y="80" width="400" height="240" rx="10" fill="#3b82f6" opacity="0.1"/>
                            <rect x="70" y="100" width="360" height="200" rx="5" fill="white" stroke="#3b82f6" stroke-width="2"/>
                            <circle cx="250" cy="200" r="40" fill="#3b82f6"/>
                            <path d="M230 200 L245 215 L270 190" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                            <rect x="200" y="320" width="100" height="10" rx="5" fill="#3b82f6"/>
                            <line x1="250" y1="300" x2="250" y2="320" stroke="#3b82f6" stroke-width="3"/>
                        </svg>
                    </div>
                </div>
            </div>
        ...
        <section class="services" id="services">
            <div class="container">
                <div class="section-title fade-in-up">
                    <h2>Layanan Kami</h2>
                    <p>Berbagai solusi lengkap untuk kebutuhan komputer dan laptop Anda</p>
                </div>
                <div class="services-grid">
                    <div class="service-card fade-in-up">
                        <div class="service-icon">🔧</div>
                        <h3>Perbaikan Hardware</h3>
                        <p>Perbaikan komponen hardware seperti motherboard, RAM, hard disk, power supply, dan lainnya dengan teknisi profesional.</p>
                    </div>
                    <div class="service-card fade-in-up">
                        <div class="service-icon">💻</div>
                        <h3>Instalasi Software</h3>
                        <p>Instalasi sistem operasi Windows, Linux, aplikasi office, antivirus, dan software lainnya sesuai kebutuhan Anda.</p>
                    </div>
                    <div class="service-card fade-in-up">
                        <div class="service-icon">⚡</div>
                        <h3>Upgrade Komputer</h3>
                        <p>Tingkatkan performa komputer Anda dengan upgrade RAM, SSD, VGA card, processor, dan komponen lainnya.</p>
                    </div>
                    <div class="service-card fade-in-up">
                        <div class="service-icon">🛡️</div>
                        <h3>Pembersihan Virus</h3>
                        <p>Hapus virus, malware, spyware, dan ancaman keamanan lainnya dengan tools profesional dan antivirus terbaik.</p>
                    </div>
                    <div class="service-card fade-in-up">
                        <div class="service-icon">🔄</div>
                        <h3>Recovery Data</h3>
                        <p>Layanan pemulihan data yang hilang atau terhapus dari hard disk, SSD, flashdisk, dan media penyimpanan lainnya.</p>
                    </div>
                    <div class="service-card fade-in-up">
                        <div class="service-icon">🌐</div>
                        <h3>Jaringan & Wifi</h3>
                        <p>Instalasi dan perbaikan jaringan komputer, setting wifi, router, dan troubleshooting masalah koneksi internet.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="features" id="features">
            <div class="container">
                <div class="section-title fade-in-up">
                    ...
                    <p>Keunggulan layanan yang kami tawarkan untuk kepuasan Anda</p>
                </div>
                <div class="features-grid">
                    <div class="feature-item fade-in-up">
                        ...
                        <div class="feature-content">
                            ...
                            <p>Tim teknisi profesional dengan sertifikasi dan pengalaman lebih dari 5 tahun di bidang IT.</p>
                        </div>
                    </div>
                    <div class="feature-item fade-in-up">
                        <div class="feature-icon">⚡</div>
                        <div class="feature-content">
                            ...
                            <p>Proses servis yang efisien dengan estimasi waktu yang jelas dan dapat diandalkan.</p>
                        </div>
                    </div>
                    <div class="feature-item fade-in-up">
                        <div class="feature-icon">💰</div>
                        <div class="feature-content">
                            ...
                            <p>Tarif kompetitif dengan kualitas terbaik. Konsultasi gratis untuk semua pelanggan.</p>
                        </div>
                    </div>
                    <div class="feature-item fade-in-up">
            ...
            <div class="container">
                <div class="footer-content">
                    ...
                    <div class="footer-section">
                        <h4>Layanan</h4>
                        <ul>
                            <li><a href="#services">Perbaikan Hardware</a></li>
